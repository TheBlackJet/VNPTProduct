    ...
    foreach ($modules as $module_key => $module) {
        ...
        if ($module['name'] == "bg_start" || $module['name'] == "bg_end") {
            ...
            switch ($module['name']) {
                ...
                case "content":
                    #heading
                    if (strlen($module['heading_color']) > 0) {
                        $custom_color = "color:#{$module['heading_color']};";
                    } else {
                        $custom_color = "";
                    }
