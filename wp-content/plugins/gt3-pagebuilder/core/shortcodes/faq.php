...
function faq_item($atts, $content = null) {
	...
	extract( shortcode_atts( array(
		...
		$compile .= "<h5 data-count='".$toggtemmpi."' class='shortcode_toggles_item_title expanded_" . $expanded_state . "'>".$title."<span class='ico_toggle'></span><span class='ico_faq'></span></h5><div class='shortcode_toggles_item_body'><div class='ip'>".do_shortcode($content)."</div></div>";
