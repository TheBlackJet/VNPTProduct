        ...
        ';
            ...
            while ($wp_query->have_posts()) : $wp_query->the_post();
                ...
                if (strlen($featured_image[0]) > 0) {
                    ...
                    $featured_image_full = '<div class="img_block wrapped_img"><a href="' . get_permalink(get_the_ID()) . '"><img width="570" height="400" src="' . $featured_image_url . '" /><div class="featured_item_fadder"></div><div class="featured_link_ico"><span><i class="icon-link"></i></span></div></a></div>';
                } else {
                    $featured_image_full = '';
                }
