...
/*require_once(GT3PBPLUGINPATH . "core/classes/css-js-generator.php");
require_once(GT3PBPLUGINPATH . "core/classes/global-js-message.php");*/
require_once(GT3PBPLUGINPATH . "core/classes/gt3_helper.php");
...
#require_once(GT3PBPLUGINPATH . "core/shortcodes/highlighter.php");
...
require_once(GT3PBPLUGINPATH . "core/shortcodes/portfolio_masonry.php");
